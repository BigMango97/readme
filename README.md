...
연령제한(15세 미만일때)|소설뷰어페이지 - 평점 등록/수정|댓글 등록|
|:-:|:-:|:-:|
|![image](https://github.com/BTS-ReadMe/readme/assets/113071800/97f6709b-cba9-4377-9b1c-f4e5cc552202)|![image](https://github.com/BTS-ReadMe/readme/assets/113071800/ed0d318c-1972-452d-be16-821a579b12a6)|![image](https://github.com/BTS-ReadMe/readme/assets/113071800/607bb0a4-b726-48e0-879b-65f874ec324d)

|이전화/다음화 보기|이모지 추가|내서재|
|:-:|:-:|:-:|
|![image](https://github.com/BTS-ReadMe/readme/assets/113071800/8c355628-6dd4-4684-8ae9-287f5508b49a)|![image](https://github.com/BigMango97/readme/assets/113071800/e26b5af5-e26c-407c-ba18-99e41b8954c2)|![내서재](https://github.com/BigMango97/readme/assets/113071800/71cd0971-a3c5-4aed-9da9-b35f6e6f67d9)



## 구현 패턴
#### 코드의 안정성과 효율성을 위한 React Query 및 TypeScript 사용
React Query를 활용하여 데이터 패칭, 캐싱, 로딩을 효율적으로 관리하였고, 사용자 자주 접하는 요소에 대해 캐싱을 적용하여 API 호출을 최적화하였습니다. 
TypeScript를 도입하여 코드의 안정성을 높이고, 타입 안정성을 확보하여 개발 과정에서 오류를 줄였습니다.
#### SSR, CSR 적용과 SEO 최적화
메인페이지, 소설 상세페이지, 조회 페이지에서 SSR(Server Side Rendering)을 적용하여 페이지 로딩 성능을 개선하였고 LightHouse를 이용한 성능 테스트 결과 53에서 93로 상승시켰습니다. 
SEO 최적화를 위해 이미지에 적절한 alt 태그를 부여하고, 페이지 title과 description을 최적화하여 검색 엔진 최적화하여 검색 엔진 노출을 향상시켰습니다.
#### 이미지 렌더링 최적화
이미지 컴포넌트를 사용하여 webP의 고품질 이미지를 더 작은 파일 크기로 제공하였습니다. 이미지를 로딩하는 동안 흐릿한 미리보기를 통해 사용자 경험을 향상시켰습니다. 
#### UI/UX 개선
사용자 경험 향상을 위해 다른 서비스 사이트를 벤치마킹하고, 사용자에게 선택의 폭을 주기 위해 Card/List 형식의 뷰를 제공하였습니다. 
소설을 클릭하고 이전 버튼을 눌렸을경우 스크롤을 기억하여 마지막 스크롤로 되돌아 갈 수 있게 구현하였습니다. 최소한의 동작으로 원하는 정보를 제공하고자합니다.
소설 뷰어페이지에서 얼만큼 읽었는지에 대해 횡단 스크롤로 나타냅니다.
#### 협업 문화 개선에 기여
프론트엔드, 백엔드 간의 원활한 커뮤니케이션 및 서비스 플로우 이해를 돕기위해, Figma를 활용한 와이어프레임 공동 작업을 제안하여 협업 문화를 개선했습니다.
